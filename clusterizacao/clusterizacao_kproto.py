...
# Clusterização
kproto = clusteriza_kproto_final(valores_k, lista_init, df_agrupado, df_agrupado_2, x, categorical_idx, graficos=False)

# Salvando o modelo
MODEL_DIR = BASE_DIR / "modelos" / "modelo_kproto.joblib"
joblib.dump(kproto, MODEL_DIR)
